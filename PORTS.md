# PrivacyEdge Local Development Ports
...
PRIVACYEDGE_CORS_ORIGINS=http://localhost:3001,http://localhost:8080
```
...
# Test Database
psql -h localhost -p 5433 -U privacyedge -d privacyedge
# Password: privacyedge
