...
> "Hi, I'm Mohana. I built ZeroBanner - a privacy-first UX analytics platform using Federated Learning.
> 
...
**Expected Output:**
```
zerobanner-fl-genai-dashboard-1    Up X minutes
zerobanner-fl-genai-api-1          Up X minutes  
zerobanner-fl-genai-postgres-1     Up X minutes (healthy)
zerobanner-fl-genai-redis-1        Up X minutes
zerobanner-fl-genai-qdrant-1       Up X minutes
```
...
**Browser:** Open `file:///home/mnvgowda/MNVProjects/ZeroBanner-FL-GenAI/demo/test-page.html`

Or with HTTP server:
```bash
cd /home/mnvgowda/MNVProjects/ZeroBanner-FL-GenAI/demo
