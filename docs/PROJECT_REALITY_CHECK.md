...
1. **Installation**:
   ```html
   <script src="https://your-domain.com/privacyedge-sdk.js"></script>
   <script>
     PrivacyEdge.init({ projectId: 'your-project-id' });
   </script>
   ```
...
3. **Dashboard**:
   - Login at `https://dashboard.privacyedge.com`
...
<body>
  ...
  <script type="module">
    ...
    await client.initialize();
    console.log('PrivacyEdge SDK loaded!');
  </script>
</body>
</html>
EOF
...
- PrivacyEdge is deployed (locally or cloud)
