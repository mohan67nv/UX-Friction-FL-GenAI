...
export DATABASE_URL=postgresql://user:pass@localhost:5432/privacyedge
...
```bash
# Database
DATABASE_URL=postgresql://user:pass@localhost:5432/privacyedge
...
GLOBAL_SYNC_ENDPOINT=https://registry.privacyedge.io
...
- **Email**: support@privacyedge.io
- **Docs**: https://docs.privacyedge.io
